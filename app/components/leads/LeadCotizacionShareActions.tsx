    ...
    return (
      <section className="mt-6 rounded-2xl border border-bloom-border bg-bloom-surface p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h2 className="font-display text-lg text-bloom-ink">Cotización</h2>
            <p className="mt-1 text-sm text-bloom-muted">
              {COTIZACION_ESTADO_LABELS[cotizacion.estado]} · aún no hay ítems
              incluidos para compartir
            </p>
          </div>
          <button
            type="button"
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            type="button"
            onClick={onEdit}
            className="inline-flex items-center gap-1.5 rounded-full border border-bloom-accent/30 bg-bloom-accent/10 px-4 py-2 text-sm font-medium text-bloom-accent transition-colors hover:bg-bloom-accent/20"
          >
            <EditIcon />
            Editar cotización
          </button>
